...
Version 0.6.29 of this plugin uses Checker Framework version 3.36.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.6.29' apply false
}
...
def checkerFrameworkVersion = "3.36.0"
