...
Version 0.5.21 of this plugin uses Checker Framework version 3.14.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.21' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.14.0'
