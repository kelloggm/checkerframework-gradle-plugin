...
plugins {
    ...
    id 'org.checkerframework' version '0.5.15'
}
...
Version 0.5.15 of this plugin uses Checker Framework version 3.9.1 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.15' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.9.1'
...
def checkerFrameworkVersion = "3.9.1"
