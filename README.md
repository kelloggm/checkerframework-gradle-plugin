...
Version 0.5.17 of this plugin uses Checker Framework version 3.11.0 by default.
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.11.0'
...
def checkerFrameworkVersion = "3.11.0"
