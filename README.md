...
plugins {
    ...
    id 'org.checkerframework' version '0.5.25'
}
...
Version 0.5.25 of this plugin uses Checker Framework version 3.18.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.25' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.18.0'
...
def checkerFrameworkVersion = "3.18.0"
