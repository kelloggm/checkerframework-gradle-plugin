...
plugins {
    ...
    id 'org.checkerframework' version '0.5.14'
}
...
Version 0.5.14 of this plugin uses Checker Framework version 3.9.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.14' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.9.0'
...
def checkerFrameworkVersion = "3.9.0"
