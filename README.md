...
Version 0.6.18 of this plugin uses Checker Framework version 3.26.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.6.18' apply false
}
...
def checkerFrameworkVersion = "3.26.0
...
For the Checker Framework to work properly on code that is generated by Lombok,
