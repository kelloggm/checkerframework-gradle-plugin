...
Version 0.6.11 of this plugin uses Checker Framework version 3.22.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.6.11' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.22.0'
...
def checkerFrameworkVersion = "3.22.0
