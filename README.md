...
Version 0.5.25 of this plugin uses Checker Framework version 3.17.0 by default.
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.17.0'
...
def checkerFrameworkVersion = "3.17.0"
