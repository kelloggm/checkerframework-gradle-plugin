...
plugins {
    ...
    id 'org.checkerframework' version '0.6.58'
}
...
Version 0.6.58 of this plugin uses Checker Framework version 3.50.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.6.58' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.50.0'
...
def checkerFrameworkVersion = "3.50.0"
