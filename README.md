...
plugins {
    ...
    id 'org.checkerframework' version '0.5.26'
}
...
Version 0.5.26 of this plugin uses Checker Framework version 3.18.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.26' apply false
}
