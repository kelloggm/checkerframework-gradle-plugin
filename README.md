...
plugins {
    ...
    id 'org.checkerframework' version '0.3.27'
}
...
This plugin uses Checker Framework version 2.10.0 by default.
...
plugins {
  ...
  id 'org.checkerframework' version '0.3.27' apply false
}
...
When using a Checker Framework version above 2.11.0 that is compatible with Java 9
...
This is necessary because Checker Framework versions starting at 2.11.0 build on the Java 9 compiler.

When using a Checker Framework version above 2.11.0 and executing on a Java 9+ JVM, the host
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.org.checkerframework:checkerframework-gradle-plugin:0.3.27-SNAPSHOT'
  }
}
