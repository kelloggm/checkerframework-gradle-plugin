...
plugins {
    ...
    id 'org.checkerframework' version '0.4.5'
}
...
plugins {
  ...
  id 'org.checkerframework' version '0.4.5' apply false
}
...
buildscript {
  ...
  dependencies {
    classpath 'gradle.plugin.org.checkerframework:checkerframework-gradle-plugin:0.4.5-SNAPSHOT'
  }
}
