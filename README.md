...
Version 0.5.22 of this plugin uses Checker Framework version 3.15.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.22' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.15.0'
...
def checkerFrameworkVersion = "3.15.0"
