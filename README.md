...
Version 0.6.9 of this plugin uses Checker Framework version 3.21.3 by default.
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.21.3
...
def checkerFrameworkVersion = "3.21.3
