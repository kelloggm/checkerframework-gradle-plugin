...
Version 0.6.60 of this plugin uses Checker Framework version 3.51.2 by default.
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.51.2'
    implementation 'org.checkerframework:checker-qual:3.51.2'
  }
}
```
...
def checkerFrameworkVersion = "3.51.2"
