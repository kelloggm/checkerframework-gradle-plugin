...
Version 0.5.23 of this plugin uses Checker Framework version 3.16.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.23' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.16.0'
...
def checkerFrameworkVersion = "3.16.0"
