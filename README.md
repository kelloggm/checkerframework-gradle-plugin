...
Version 0.5.13 of this plugin uses Checker Framework version 3.8.0 by default.
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.8.0'
...
def checkerFrameworkVersion = "3.8.0"
