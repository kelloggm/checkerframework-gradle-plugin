...
Version 0.5.16 of this plugin uses Checker Framework version 3.10.0 by default.
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.10.0'
...
def checkerFrameworkVersion = "3.10.0"
