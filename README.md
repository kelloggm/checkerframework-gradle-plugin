...
Version 0.5.10 of this plugin uses Checker Framework version 3.6.1 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.10' apply false
}
...
subprojects { subproject ->
  ...
  dependencies {
    checkerFramework 'org.checkerframework:checker:3.6.1'
...
def checkerFrameworkVersion = "3.6.1"
