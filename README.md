...
Version 0.6.16 of this plugin uses Checker Framework version 3.24.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.6.16' apply false
}
...
def checkerFrameworkVersion = "3.24.0
