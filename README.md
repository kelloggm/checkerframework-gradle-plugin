...
Version 0.5.18 of this plugin uses Checker Framework version 3.12.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.18' apply false
}
...
def checkerFrameworkVersion = "3.12.0"
