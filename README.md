...
Version 0.6.20 of this plugin uses Checker Framework version 3.28.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.6.20' apply false
}
...
def checkerFrameworkVersion = "3.28.0"
