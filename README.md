...
Version 0.5.11 of this plugin uses Checker Framework version 3.7.0 by default.
...
```groovy
plugins {
  id 'org.checkerframework' version '0.5.11' apply false
}
...
def checkerFrameworkVersion = "3.7.0"
